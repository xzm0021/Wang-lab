...
special_key_value=[["MT","chrM"],["PJAA","chrUn"]] 
...
dp="Equus_caballus.EquCab3.0.98.ensembl.gtf"
output_gtf="Equus_caballus.EquCab3.0.98.ensembl.chr.cor.unchecked.gtf"
...
gtf_df.to_csv(output_gtf,header=None,index=None,sep=gtf_sep)
